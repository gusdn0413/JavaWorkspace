...
//        langList.add("c#");
        ...
        // 90점 이상인 점수만 출력
        Arrays.stream(scores).filter(score -> score >= 90).forEach(score -> System.out.println(score));

        System.out.println("------------------------------");

        Arrays.stream(scores).filter(score -> score >= 90).forEach(System.out::println);

        System.out.println("------------------------------");

        // 90점 이상인 사람의 수
        int count = (int) Arrays.stream(scores).filter(score -> score >= 90).count();
        System.out.println(count);

        System.out.println("------------------------------");

        // 90점 이상인 점수들의 합
        int sum = Arrays.stream(scores).filter(score -> score >= 90).sum();
        System.out.println(sum);

        System.out.println("------------------------------");

        // 90점 이상인 점수들을 정렬
        Arrays.stream(scores).filter(score -> score >= 90).sorted().forEach(System.out::println);
